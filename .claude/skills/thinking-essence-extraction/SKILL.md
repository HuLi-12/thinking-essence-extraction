...
如果存在 `remote_sensing_segmentation_examples.md`，在分析遥感语义分割、DeepLabV3+、ASPP、decoder、LoveDA、mIoU、class-wise IoU、边界类、小目标类等问题时，优先参考其中的案例风格，但不要机械复制结论——**迁移结构，不复用结论**。
